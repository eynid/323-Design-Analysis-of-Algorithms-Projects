...
class HNode{
    ...
    void printNode(HNode T, FileWriter outFile) throws IOException{
        ...
        //Printing Node. We need to know if some nodes will be null, so they can be printed appropriately.
...
class HuffmanTree{
    ...
    //Counters to be able to neatly print 3 lines for each traversal. 
